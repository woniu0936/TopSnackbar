...
import static demo.library.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;

/**
 * @author woniu
 * @title BaseTransientTopBar
 * @description
 * @modifier
 * @date
 * @since 17/5/8 下午1:05
 */
public class BaseTransientTopBar<B extends BaseTransientTopBar<B>> {
