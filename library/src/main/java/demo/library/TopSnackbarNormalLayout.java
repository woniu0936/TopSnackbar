...
/**
 * @author woniu
 * @title TopSnackbarNormalLayout
 * @description
 * @modifier
 * @date
 * @since 17/5/8 下午4:38
 */
public class TopSnackbarNormalLayout extends TopSnackbarContentLayout {
    ...
    public TopSnackbarNormalLayout(Context context) {
        this(context, null);
    }

    public TopSnackbarNormalLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
